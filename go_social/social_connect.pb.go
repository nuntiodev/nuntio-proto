...
type ConnectPublicResponse struct {
	...
	Error        Error  `protobuf:"varint,4,opt,name=error,proto3,enum=Social.Error" json:"error,omitempty"`
}
...
var file_social_connect_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x2e, 0x45, 0x72,
