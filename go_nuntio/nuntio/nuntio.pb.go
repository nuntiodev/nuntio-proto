...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nuntio_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_nuntio_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75,
	...
	0x67, 0x2a, 0x55, 0x0a, 0x0f, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65,
	...
	0x54, 0x52, 0x59, 0x5f, 0x44, 0x45, 0x10, 0x03, 0x2a, 0x3d, 0x0a, 0x06, 0x47, 0x65, 0x6e, 0x64,
	...
	0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x03, 0x2a, 0x33, 0x0a, 0x18, 0x56, 0x65, 0x72, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x00,
	0x12, 0x0a, 0x0a, 0x06, 0x4d, 0x49, 0x54, 0x5f, 0x49, 0x44, 0x10, 0x01, 0x42, 0x14, 0x5a, 0x12,
...
var file_nuntio_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_nuntio_proto_goTypes = []interface{}{
	...
	(*Request)(nil),               // 5: Nuntio.Request
	(*Response)(nil),              // 6: Nuntio.Response
}
...
func file_nuntio_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nuntio_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
