...
type Country struct {
	...
	CountryCode CountryCode `protobuf:"varint,1,opt,name=country_code,json=countryCode,proto3,enum=Social.CountryCode" json:"country_code,omitempty"`
	Name        string      `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
}
...
type Error struct {
	...
	Error   ErrorType `protobuf:"varint,1,opt,name=error,proto3,enum=Social.ErrorType" json:"error,omitempty"`
...
var file_social_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x53, 0x6f, 0x63, 0x69,
	0x61, 0x6c, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x0b,
	...
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c,
	...
	0x10, 0x01, 0x2a, 0xaa, 0x01, 0x0a, 0x09, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x54, 0x79, 0x70, 0x65,
	...
	0x54, 0x5f, 0x49, 0x53, 0x5f, 0x4e, 0x4f, 0x54, 0x5f, 0x4f, 0x50, 0x45, 0x4e, 0x10, 0x05, 0x42,
...
var file_social_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_social_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_social_proto_goTypes = []interface{}{
	(CountryCode)(0),              // 0: Social.CountryCode
	(Gender)(0),                   // 1: Social.Gender
	(VerificationProviderType)(0), // 2: Social.VerificationProviderType
	(ErrorType)(0),                // 3: Social.ErrorType
	(*VerificationProvider)(nil),  // 4: Social.VerificationProvider
	(*Country)(nil),               // 5: Social.Country
	(*Error)(nil),                 // 6: Social.Error
}
var file_social_proto_depIdxs = []int32{
	2, // 0: Social.VerificationProvider.type:type_name -> Social.VerificationProviderType
	0, // 1: Social.Country.country_code:type_name -> Social.CountryCode
	3, // 2: Social.Error.error:type_name -> Social.ErrorType
